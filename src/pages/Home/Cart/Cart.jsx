            ...
            <main className="mt-6 px-4 md:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex gap-2 border-b border-slate-300 pb-4 dark:border-neutral-700">
                        ...
                        <p className="text-base text-slate-900 font-medium dark:text-slate-50">4 Items</p>
                    </div>

                    <div className="grid lg:grid-cols-3 gap-12">
                        <ul className="lg:col-span-2 divide-y divide-slate-300 dark:divide-neutral-700">
                            <li className="flex flex-col gap-6 py-6 sm:items-center sm:flex-row">
                                ...
                                <div className="flex items-start gap-4 w-full">
                                    <div>
                                        <h3 className="text-base font-semibold text-slate-900 mb-2 dark:text-slate-50">Sweater</h3>
                                        <div className="space-y-2">
                                            <p className="text-sm text-slate-600 dark:text-slate-400">Size: <span
                                                className="ml-2 font-medium">MD</span></p>
                                            <p className="text-sm text-slate-600 dark:text-slate-400">Color: <span
                                                className="ml-2 font-medium">Black</span>
                                            </p>
                                        </div>
                                    ...
                                    <div className="ml-auto text-right">
                                        ...
                                        <div className="mt-6">
                                            <p className="text-base font-semibold text-slate-900 dark:text-slate-50">$18.50</p>
                                            <p className="text-base text-slate-500 mt-1"><strike className="font-medium">$22.50</strike>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <ul
                                ...
                                <li className="flex flex-wrap gap-4 text-sm py-3">Subtotal <span
                                    className="ml-auto font-semibold text-slate-900 dark:text-slate-50">$56.00</span></li>
                                <li className="flex flex-wrap gap-4 text-sm py-3">Shipping <span
                                    className="ml-auto font-semibold text-slate-900 dark:text-slate-50">$4.00</span></li>
                                ...
                                <li className="flex flex-wrap gap-4 text-sm py-3 font-semibold text-slate-900 dark:text-slate-50">Total
                                    <span className="ml-auto dark:text-slate-50">$64.00</span>
                                </li>
                            </ul>
                            ...
                            <form className="max-w-sm mt-8">
                                <label for="promocode" className="mb-2 block text-sm font-medium text-slate-900 dark:text-slate-50">Do
                                    you
